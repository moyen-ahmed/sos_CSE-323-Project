...
import 'home_widgets/live_safe/HomeLocationCard.dart';
...
{
Fluttertoast.showToast(msg: 'Something is wrong ! call emergency number');
}
}
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          HomeLocationCard(onMapFunction: openMap),
        ],
      ),
    );
  }
